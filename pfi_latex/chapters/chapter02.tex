...
El trabajo de \textcite{SchaerKourentzesFildes2019}, vinculado con demand forecasting e información generada por usuarios en línea, analiza cómo incorporar señales digitales externas dentro de modelos de predicción de demanda, y respalda la idea de que los datos generados en entornos digitales pueden aportar valor predictivo cuando se los organiza y analiza temporalmente.
...
El trabajo de \textcite{SalamaiAgeeliElkenawy2022} aborda el uso de modelos basados en LSTM para analizar comportamientos temporales en comercio electrónico. Este tipo de arquitectura captura dependencias de largo plazo, lo que ayuda a comprender cómo pueden modelarse patrones de comportamiento cuando existe suficiente información histórica.
