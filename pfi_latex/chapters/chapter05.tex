...
\textbf{Flujos de ingreso}: modelo freemium por suscripción mensual, ya implementado (RF08, Sección~\ref{sec:demo-cuentas}) y no solo planificado: sin cuenta se ve el ranking completo, pero la exportación CSV, el historial de evolución completo y las alertas por producto seguido (RF09) requieren registrarse. El precio de referencia -- validado en la Entrevista 2 en un rango de USD 10 a 30 mensuales (Anexo D) -- todavía no está cobrado en producción (no hay pasarela de pago integrada); por ahora el registro es gratuito y lo que se valida es el mecanismo de diferenciación de niveles, no la cobranza en sí.
...
\textbf{Sustentabilidad}: al ser un producto de software con costo marginal casi nulo por usuario adicional -- la infraestructura actual ya sostiene 274 productos y más de 11.500 scores calculados sin necesidad de escalar (Sección~\ref{sec:evidencia-cuantitativa}) --, el margen de contribución por suscriptor es alto una vez cubiertos los costos fijos. El punto de equilibrio y los escenarios de rentabilidad se desarrollan en la Sección~\ref{sec:viabilidad-economica}.
