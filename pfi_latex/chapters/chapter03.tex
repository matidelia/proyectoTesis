...
El proyecto no aborda una temática sensible en términos legales -- no procesa datos de salud, alimentación ni pone en riesgo la vida de los usuarios --: opera exclusivamente sobre datos públicos de productos, precios y categorías obtenidos mediante la API oficial de Mercado Libre (Sección~\ref{sec:tecnologias-utilizadas}), sin acceder a información privada ni a datos personales de compradores o vendedores (Sección~\ref{sec:alcance}). Por ese motivo, no corresponde incluir un descargo de responsabilidad legal específico más allá del cumplimiento de los términos de uso de la API oficial, ya documentado como RNF05 (gestión segura de credenciales OAuth2 exclusivamente del lado servidor, Sección~\ref{sec:trazabilidad}).
