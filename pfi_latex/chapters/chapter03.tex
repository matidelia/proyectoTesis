...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{1.6cm} >{\raggedright\arraybackslash}p{2.1cm} >{\raggedright\arraybackslash}p{8.3cm} >{\raggedright\arraybackslash}p{2.1cm}@{}}
	...
	RF05 & Implementado & Gráfico de evolución de precio por producto y panel de tendencias desglosado por categoría, ambos en el dashboard. & Fig.~\ref{fig:demo-dashboard} \\
