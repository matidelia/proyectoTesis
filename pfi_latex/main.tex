...
% Propuesta de Tema formalmente aprobada y firmada (Alumno: D'Elia, Matías —
% Tutor: Salas, Joaquín). Se incrusta el PDF escaneado completo (7 páginas,
% con firmas originales) en lugar de retranscribirlo.
\clearpage
\thispagestyle{empty}
